      ...
      <div class="w-full lg:w-8/12 my-6">
        ...
        <div class="p-5 mt-6 w-full h-80">
          <div class="flex w-full justify-between">
            <div class="w-5/12">
              <canvas id="graph-transaction-canvas"></canvas>
            </div>
        ...
        <div class="flex justify-end mt-6">
          <button
            @click.prevent="processTransactions()"
            class="
              inline-block
              whitespace-nowrap
              text-white
        ...
        >
          <div class="flex flex-wrap mb-6 justify-between">
            <div class="w-3/12">
              ...
              <multiselect
                v-model="searchFilter.treasuryId"
                :allow-empty="false"
                :showLabels="false"
                :showPointer="false"
                label="name"
